...
//      i.e: profilePictureLink: require("../editable-stuff/deepa-cv.png"),
...
const about = {
  ...
  resume: require("../editable-stuff/Deepa_Venkatachalapathi_Resume.pdf"),
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/deepa-cv.jpg"), 
